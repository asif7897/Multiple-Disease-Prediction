...
Created by: Md Asif Mahmud and Ashiqur Rahman Chisty
Institution: Institution of Science and Technology
...
diabetes_model_path = os.path.join(base_path, 'diabetes_model.sav')
heart_disease_model_path = os.path.join(base_path, 'heart_disease_model.sav')
parkinsons_model_path = os.path.join(base_path, 'parkinsons_model.sav')
